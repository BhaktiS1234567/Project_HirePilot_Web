    ...
    <div className="backdrop-blur-md bg-white/30 border border-white/40 p-10 rounded-2xl shadow-xl max-w-3xl mx-auto mt-10">
      ...
      {isEditing && (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
          <div className="bg-white/70 backdrop-blur-md p-8 rounded-2xl shadow-2xl w-[90%] sm:w-[500px] relative">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 border text-black border-gray-300 rounded-md focus:ring-2 focus:ring-amber-500 outline-none"
                />
              </div>
